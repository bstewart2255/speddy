-- Migration: Add WJ-IV to student_assessments table
-- Date: 2025-11-24
-- Description: Updates the CHECK constraint on student_assessments.assessment_type to include 'wj_iv'

-- Drop the existing CHECK constraint
ALTER TABLE student_assessments
DROP CONSTRAINT IF EXISTS student_assessments_assessment_type_check;

-- Add the updated CHECK constraint with wj_iv
ALTER TABLE student_assessments
