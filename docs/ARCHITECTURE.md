...
| Teacher student view | "Resource Specialist" → "Case Manager"; elementary scheduling/service-minute cards dropped. (Accommodations show at every site type since SPE-488 — no longer a secondary-only surface.) | `app/(dashboard)/dashboard/teacher/my-students/[studentId]/page.tsx` |
