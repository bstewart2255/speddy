...
export function DailyTimeMarker({ time, label, color, pixelPosition, gradeLevel }: DailyTimeMarkerProps) {
  ...
  return (
    ...
    >
      {/* Dashed line */}
      <div className={`absolute left-0 right-0 border-t-2 border-dashed ${lineColor} opacity-60`} />

      {/* Label pill */}
      <div
        className={`absolute left-1 -top-2.5 px-1.5 py-0.5 text-[10px] font-medium rounded border ${colorClasses} whitespace-nowrap`}
      >
