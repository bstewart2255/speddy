...
- Middle and high school (secondary) sites work differently, by role. Resource specialists keep Schedule and Bell Schedules but lose Special Activities and Plan; they plan service as weekly minutes rather than sessions, and their Schedule page is a periods-by-days week view instead of the drag-and-drop grid. Speech, OT, counseling and school psychologists keep everything except Special Activities, including Plan and the normal session grid. Every other role loses Schedule, Bell Schedules, Special Activities and Plan entirely. The "This Week's Attendance" widget and a student's Attendance tab are elementary-only.
